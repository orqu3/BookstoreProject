...
function generateTrackCode() {
    ...
    currentDataTime = formatDateCurrentTime();

    html = `
            <div class="border rounded p-1" id="${rowId}">
                        <input type="hidden" name="trackId" value="0" class="hiddenTrackId"/>
                        <div class="col-2">
                            <div class="divCountTrack">
                                ${nextCount}
                            </div>
                            <div class="mt-1">
                                <a 
                                class="fas fa-trash icon-dark linkRemoveTrack" 
                                href="" 
                                rowNumber = "${nextCount}"
                                ></a>
                            </div>
                        ...
                        <div class="col-10">
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    <input type="datetime-local" name="trackDate" value="${currentDataTime}"
                                    class="form-control"
                                    required
    ...
    htmlCode += `
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    <textarea class="form-control" name="trackNotes" cols="10" rows="2"
                                    style="max-width: 300px"
                                    id=${trackNoteId}"
...
function formatDateCurrentTime() {
    date = new Date();
